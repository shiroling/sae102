...
package resolutions is
  ...
  -- permet d'obtentir le nombre se soutions possbles pour une case donnÈe
  function masseCase(g: in Type_Grille; c: in Type_Coordonnee) return Integer;


  -- retourne les coordonnees de la remiÈre case avec le moins de solution possibles d'une grille g
